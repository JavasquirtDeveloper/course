...
class _$_User extends _User {
  ...
  @override
  String toString() {
    return 'User(name: $name, course: $course, group: $group, isStudent: $isStudent, personalInfo: $personalInfo, id: $id, dataOfBirth: $dataOfBirth, roomNumber: $roomNumber, specialty: $specialty, floor: $floor, prise: $prise, paid: $paid)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, course, group, isStudent,
      personalInfo, id, dataOfBirth, roomNumber, specialty, floor, prise, paid);
